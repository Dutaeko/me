...
public class BrowseSourceAnimeAdapter extends BaseAdapter {
    ...
    private View getListView(AnimePost post, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || !(convertView.getTag() instanceof ListHolder)) {
            ...
            episode.setTextColor(ThemeManager.color(context, androidx.appcompat.R.attr.colorPrimary, 0xFF6750A4));
            episode.setTextSize(12);

            TextView meta = new TextView(context);
            meta.setSingleLine(true);
            meta.setEllipsize(android.text.TextUtils.TruncateAt.END);
            meta.setTextColor(ThemeManager.color(context, com.google.android.material.R.attr.colorOnSurfaceVariant, 0xFF49454F));
            meta.setTextSize(12);

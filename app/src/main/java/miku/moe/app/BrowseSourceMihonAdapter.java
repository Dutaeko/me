...
public class BrowseSourceMihonAdapter extends BaseAdapter {
    ...
    private View getListView(MangaPost post, View convertView, ViewGroup parent) {
        ...
        if (convertView == null || !(convertView.getTag() instanceof ListHolder)) {
            ...
            title.setTextColor(ThemeManager.color(context, com.google.android.material.R.attr.colorOnSurface, 0xFF1C1B1F));
            ...
            chapter.setTextColor(ThemeManager.color(context, androidx.appcompat.R.attr.colorPrimary, 0xFF6750A4));
    ...
    private void bindCover(ImageView image, MangaPost post, Object holder) {
        ...
        if (cover.isEmpty()) {
            ...
            image.setBackgroundColor(ThemeManager.color(context, com.google.android.material.R.attr.colorSurfaceContainerHighest, 0x1F888888));

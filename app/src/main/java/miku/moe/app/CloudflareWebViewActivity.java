...
public class CloudflareWebViewActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        int surface = ThemeManager.getThemedColor(this, com.google.android.material.R.attr.colorSurface, Color.BLACK);
        int surfaceVariant = ThemeManager.getThemedColor(this, com.google.android.material.R.attr.colorSurfaceVariant, 0xCC000000);
        int onSurface = ThemeManager.getThemedColor(this, com.google.android.material.R.attr.colorOnSurface, Color.WHITE);
        ...
        String challengeUa = CloudflareHelper.userAgentForHost(host);
        settings.setUserAgentString(challengeUa);
        CloudflareHelper.setUserAgentForHost(host, challengeUa);

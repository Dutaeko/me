...
public class MangaDetailFragment extends Fragment {
    ...
    private void setupStickyChapterHeader(View root){
        ...
        stickyChapterHeaderLayout.setBackgroundColor(ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorSurfaceContainerHigh, Color.DKGRAY));
        ...
        stickyChapterCountText.setTextColor(ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorOnSurface, Color.WHITE));
    ...
    private MaterialButton createStickyChapterButton(int icon){
        ...
        button.setIconTint(ColorStateList.valueOf(ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorOnSurface, Color.WHITE)));
        button.setBackgroundTintList(ColorStateList.valueOf(com.google.android.material.color.MaterialColors.layer(
                Color.TRANSPARENT, ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorOnSurface, Color.WHITE), 0.22f)));
    ...
    private void bindHeader(boolean animate){
        ...
        if(!empty(manga.info)) {
            ...
            if(isKuromanga() || isIsekaiKomik()) infoRows = filterHiddenGenreInfoRows(infoRows);
    ...
    private String[] filterHiddenGenreInfoRows(String[] rows){
        ArrayList<String> out = new ArrayList<>();
        if(rows == null) return new String[0];
        for(String row : rows){
            if(row == null) continue;
    ...
    private TextView createDetailGenreLabel(String text, boolean enabled, View.OnClickListener listener){
        ...
        label.setText(text);
        label.setTextColor(ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorOnSurface, Color.WHITE));
        ...
        label.setBackgroundResource(R.drawable.manga_detail_status_pill_background);
    ...
    private void updateFav(){
        ...
        favoriteButton.setIconTint(ColorStateList.valueOf(favorite
                ? ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorError, Color.rgb(255, 54, 84))
                : ThemeManager.color(requireContext(), com.google.android.material.R.attr.colorOnPrimary, Color.WHITE)));
    }

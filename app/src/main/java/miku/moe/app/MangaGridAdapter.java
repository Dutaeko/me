...
public class MangaGridAdapter extends BaseAdapter {
    ...
    @Override public View getView(int pos, View v, ViewGroup parent) {
        ...
        if (coverUrl.isEmpty()) {
            ...
            h.image.setBackgroundColor(ThemeManager.color(context, com.google.android.material.R.attr.colorSurfaceContainerHighest, 0x1F888888));
            ...
            h.image.setBackgroundColor(ThemeManager.color(context, com.google.android.material.R.attr.colorSurfaceContainerHighest, 0x1F888888));
            setCoverLoading(h, !MangaCoverCache.isSaved(context, coverUrl));
        ...
        if (p.favoriteChapterBase > 0 && p.favoriteChapterAdded > 0) {
            chapter = MangaLabelUtils.favoriteChapterIncreaseLabel(p.favoriteChapterBase, p.favoriteChapterAdded, context);
            hasChapter = true;
        } else {
        ...
        if (chapterView != null) {
            if (hasChapter) {
                ...
                if (plainCompactChapter) {
                    ...
                    chapterView.setTextColor(ThemeManager.color(context, com.google.android.material.R.attr.colorOnSurfaceVariant, 0xFF49454F));
                    chapterView.setBackgroundColor(0x00000000);
                    chapterView.setMinWidth(0);
                    chapterView.setPadding(0, 0, 0, 0);
                } else {
